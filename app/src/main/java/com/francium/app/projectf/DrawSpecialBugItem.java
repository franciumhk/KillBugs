...
public class DrawSpecialBugItem {
    ...
    public DrawSpecialBugItem(int[] textureId) {
        this.textureId = textureId;
        action = new ActionSpecialItem();
    }
    ...
    public void draw(GL10 gl, int col, int row) {
        ActionSpecialItem mAction = (ActionSpecialItem) action;
        ...
        gl.glBindTexture(GL10.GL_TEXTURE_2D, textureId[mAction.getPicId()]);
